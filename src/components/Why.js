...
const Why = () => {
  return (
    <section className='flex flex-wrap text-center lg:text-left flex-col-reverse items-center justify-center lg:flex-row gap-10  bg-slate-700 text-white px-4 py-10'>
